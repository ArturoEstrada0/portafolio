      ...
      {skills.map((skill) => {
        ...
        return (
          <div key={skill.name} className="flex flex-col items-center group">
            ...
            <span className="mt-2 text-xs text-center text-gray-200 font-medium">
              {skill.name}
            </span>
          </div>
        );
...
export default function Skills() {
  return (
    <div
      id="habilidades"
      className="max-h-screen z-10 py-8 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center overflow-hidden relative"
    >
      ...
      <div className="w-full max-w-5xl aspect-square bg-gradient-to-br from-black via-gray-900 to-gray-800 backdrop-blur-sm shadow-2xl rounded-2xl overflow-hidden border border-gray-200">
