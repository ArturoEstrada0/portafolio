export const Feature = () => {
    return (
      <div id="tecnologias" className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
          ...
          <div className="lg:w-1/2">
            <p className="text-base text-gray-700 md:text-lg">
              Estas habilidades las he ido desarrollando a lo largo de mi carrea la mayoria de forma autodidacta, me gusta aprender nuevas herramientas y me he desenvuelto en su mayoria en entornos de JavaScript.
            </p>
          </div>
        </div>
        <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Fronted</h6>
          ...
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">BD</h6>
            <p className="mb-3 text-sm text-gray-900">
          ...
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Desing</h6>
            <p className="mb-3 text-sm text-gray-900">
