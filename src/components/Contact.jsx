  ...
  return (
    ...
    >
      ...
      <div className="relative z-30 text-white text-center">
        <h2 className="text-5xl font-bold mb-4 animate__animated animate__fadeInDown">
          ¡Contáctame!
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <a href="tel:+524434395522" className="text-gray-800">
            <div className="bg-white rounded-lg p-6 hover:shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
              <img
                src="https://www.phoenixgroup.org.uk/images/icons/icon-blue-contact.png"
                alt="Teléfono"
          ...
          <a href="https://wa.me/524434395522" className="text-gray-800">
            <div className="bg-white rounded-lg p-6 hover:shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
              <img
                src="https://freepngimg.com/thumb/whatsapp/77102-whatsapp-computer-call-telephone-icons-png-image-high-quality.png"
                alt="WhatsApp"
                className="h-12 w-12 mx-auto mb-4"
              />
              <p className="text-lg font-semibold text-gray-800 mb-2">
